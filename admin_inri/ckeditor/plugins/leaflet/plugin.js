    ...
    init: function(editor) {
      ...
      editor.widgets.add('leaflet', {
        ...
        downcast: function(element) {
          ...
          var mapParserPathFull = mapParserPath + "?lat=" + currentLat + "&lon=" + currentLon + "&width=" + width + "&height=" + height + "&zoom=" + currentZoom + "&text=" + popUpText + "&tile=" + tile + "&minimap=" + minimap + "&responsive=" + responsive + "&scrollWheelZoom=false";
